...
function testEnv(): AppEnv {
  return {
    ...
    MEDIA_CLEANUP_CLAIM_STALE_AFTER_MS: 15 * 60_000,
    MEDIA_CLEANUP_MAX_ATTEMPTS: 3,
    ...
    OPPORTUNITY_RESEARCH_PROVIDER: "mock",
    OPPORTUNITY_RESEARCH_MODEL: "deepseek-v4-flash",
    ...
    PUBLIC_WEB_SEARCH_TIMEOUT_MS: 15_000,
    PUBLIC_WEB_SEARCH_MAX_RESPONSE_BYTES: 1_000_000,
    WORK_RECOVERY_STALE_AFTER_MS: 15 * 60_000,
    WORK_RECOVERY_MAX_COUNT: 3,
    WORK_RECOVERY_BATCH_SIZE: 25,
    OPPORTUNITY_RESEARCH_HEARTBEAT_MS: 60_000
  };
}
