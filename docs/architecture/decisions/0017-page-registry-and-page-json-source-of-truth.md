...
16. Add the first visual Page Studio workspace: registry-owned property controls, domain-derived movement legality, registry-derived variants, stale-base navigation, rendered preview parity, structured section notes, and bounded predecessor-blocker context. Done in the visual Page Studio slice; media, section replacement, and AI copy actions remain follow-ups.
