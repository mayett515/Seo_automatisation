...
20. Add binary renderer/preview/deploy parity: explicit UTF-8/base64 static files, a decoded artifact budget, shared project-scoped manifest resolution, signed sandbox-preserving preview document/asset capabilities, and deploy-time verified media-byte embedding before provider handoff. Done in ADR 0020 slice 2; the first registry media section and Page Studio controls remain follow-up work.
