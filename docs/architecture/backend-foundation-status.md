...
| Proxy/rate-limit topology | Finished foundation         | Broad `TRUST_PROXY=true` is rejected in production; Redis-backed rate limits are wired. Accepted-event/write-protection tracking buckets fail closed in strict production posture when Redis is unavailable; pre-validation buckets remain soft throttles that may degrade locally.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
