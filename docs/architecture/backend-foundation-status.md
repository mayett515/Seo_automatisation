...
- Add a rollback point preparation idempotency guard, likely a database uniqueness/conflict path for concurrent preflight calls that target the same release/source.
