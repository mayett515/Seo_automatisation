...
| Preview and approval UI           | Baseline        | Pages renders API-produced sandboxed preview HTML, records section notes, blocks approval on unresolved approval blockers, and writes durable approval/request-changes audit rows. Full Page Studio editing remains planned.                                                     |
