...
stateDiagram-v2
  ...
  ApprovedForDeploy --> Ready: preflight rerun passes
  ApprovedForDeploy --> ReadyWithWarnings: preflight rerun warns
  ApprovedForDeploy --> Blocked: preflight rerun blocks
